...
package com.xebialabs.xlrelease.plugin.rtcjazz.ccm.parameter;
	...
	private String getParameterHelp(ParameterList parameters, boolean detailled) {
		...
		for (Parameter parameter : parameters) {
			...
			if (parameter.isSwitch()) {
				commandSwitchPrefix = IWorkItemConstants.PREFIX_SWITCH;
			} else if (parameter.isCommand()) {
				commandSwitchPrefix = IWorkItemConstants.PREFIX_COMMAND;
			} else {
				value = "=\"value\"";
			}
